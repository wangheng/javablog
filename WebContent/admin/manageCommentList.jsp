...
<% 
	...
	List<CommentContent> list=(List<CommentContent>)request.getAttribute("list");
...
<table cellspacing=0 cellpadding=0 width="100%" border=0>
	<tbody>
		<tr>
			...
			<div class=containertitle><b>评论内容管理</b></div>
			...
			<table width="100%" id="adm_log_list" class="item_list">
				<thead>
					<tr>
						...
						<th width="146"><b>评论编号</b></th>
						<th width="146"><b>评论内容</b></th>
						<th width="490"><b>评论人</b></th>
...
%>
					<tr>
						<td><input type="checkbox" name="blog[]" value="3"
							class="ids" /></td>
						<td><a href="#"><%=cc.getId() %></a></td>
						<td><%=cc.getContent() %></td>
						<td><a href="#"></a><%=cc.getUsername() %></td>
						
						<td><%=cc.getCreatedtime() %></td>
						<td class="tdcenter"><a
							href="/nextplus-blog/Comment?method=edit&id=<%=cc.getId() %>"><img
							src="/nextplus-blog/images/addblog.gif" /></a></td>
						<td class="tdcenter"><a
							href="/nextplus-blog/Comment?method=delete&id=<%=cc.getId() %>"
