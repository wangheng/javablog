...
<link href="http://localhost:8080/nextplus-blog/css/login.css" rel="stylesheet" type="text/css">
<title>用户登录</title>
</head>
<body>
...
%>
<br />
<form action="/nextplus-blog/User" method="post">
<input type="hidden" name="method" value="login" />
<div class="login-main">
	<div class="login-top"></div>
	<div class="login-logo"><a href="#" target="_blank"><img src="../images/logo.png" alt="login" width="294" height="68" /></a></div>
