...
<table cellspacing=0 cellpadding=0 width="100%" border=0>
	<tbody>
		<tr>
			...
			<div class=containertitle><b>博文分类管理</b></div>
			...
			<table width="100%" id="adm_log_list" class="item_list">
				<thead>
					<tr>
						...
						<th width="146"><b>分类编号</b></th>
						<th width="490"><b>分类标题</b></th>
						<th width="146"><b>显示顺序</b></th>
...
%>
					<tr>
						<td><input type="checkbox" name="blog[]" value="3"
							class="ids" /></td>
						<td><a href="#"><%=category.getId()%></a></td>
						<td><a href="#"></a><%=category.getName()%></td>
						<td><%=category.getLevel() %></td>
						<td class="tdcenter"><a
							href="/nextplus-blog/DealCategory?method=edit&id=<%=category.getId() %>"><img
							src="/nextplus-blog/images/addblog.gif" /></a></td>
						<td class="tdcenter"><a
							href="/nextplus-blog/DealCategory?method=delete&id=<%=category.getId() %>"
